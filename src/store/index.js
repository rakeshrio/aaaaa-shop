...
export default new Vuex.Store({
  ...
  actions: {
    getModels({commit}){
      axios.get('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/otr-list').
      then(data=> {
    ...
    // getAllBrands({commit}){
    //   axios.get('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/makes/data').
    //   then(data=> {
    //     commit('getAllBrands', data.data)
    //   });
    // },
    getAllBrands({commit}){
      axios.get('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/get-brand/data').
      then(data=> {
        commit('getAllBrands', data.data)
      });
    },
    ...
    getModelsWithoutDealer({commit},payload){
      axios.get('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/model-data-without-dealer/' + payload.id).
      then(data=> {
        commit('getModelsWithoutDealer', data.data)
      });
    },
    getModelsWithMake({commit},payload){
      axios.post('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/make' , {
        make:payload.id
      }).
      then(data=> {
    ...
    getModelsWithMakeAndBudget({commit},payload){
      axios.post('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/filter/make/budget' , {
        make:payload.make,
    ...
    getModelWithSearch({commit},payload){
      axios.post('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/filter-model' , {
        contains:payload.id
      }).
      then(data=> {
    ...
    getModelsWithType({commit},payload){
      axios.post('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/type' , {
        type:payload.id
      }).
      then(data=> {
    ...
    getModelsWithBudget({commit},payload){
      axios.post('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/budget' , {
        price:payload.id
      }).
      then(data=> {
    ...
    getModelsWithDisplacement({commit},payload){
      axios.post('https://ontrack-backend-express-v1.herokuapp.com/api/otr_models/displacement' , {
