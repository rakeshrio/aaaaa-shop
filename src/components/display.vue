<template>
  <div class="col-md-12 display p-0 mb-5" style="margin: 0 auto; background:#f1f1f1; ">
    <div class="position-sticky">
          <h2 class="heading-title mb-0 pb-0">{{ vehicle.make }} {{ vehicle.model }}</h2>
    </div>
    ...
    <div class="row col-md-12  m-0 p-0" v-if="currentSelected.length > 0" >
      ...
      <div style="" class="col-md-6 text-left mt-5  col-sm-order-1 discription">
        <!-- <div class="col-md-12 ">
          <h2 class="heading-title">{{ vehicle.make }} {{ vehicle.model }}</h2>
        </div> -->
        <div class="col-md-10 mb-4">
          <label for="variant">Select Variant : </label>
          <select class="form-control " v-model="variant" @change="setVariant()" style="border: 1px solid #4e44d8 !important;" >
            <option
              :value="data.variant "
        ...
        <div class="col-md-12 row ml-0 pl-0 mt-3" v-if="currentSelected && variant && currentSelected[0].description  && colorCheck">
                <div class="d-flex px-3">
                  ...
                  <div class="popup pl- ml-0 " @click="popip"> <i class="fa fa-info-circle " style="font-size:30px;color:#4e44e8" aria-hidden="true" ></i>
                    <p class="popuptext p-2" id="myPopup">{{currentSelected[0].description}}</p>
                  </div>
                </div>
        ...
        <div class="col-md-12  text-left px-3 my-4">
          <div v-if="currentSelected[0].add_ons.length > 0 && variant && colorCheck">
              <p class="heading-title mt-4 mb-2 m-0 p-0 pb-2" style="font-size:15px"><span><img src="../assets/plus.png" width="20px" alt=""></span> Add-ons</p>
              <div class="mb-2 m-0 p-3 col-md-12 " :class="{'ifselected':checkIfSelected(data)}"  v-for="(data, index) in currentSelected[0].add_ons" :key="index" style="border-radius:5px;box-shadow: 0 1px 12px rgba(51,51,51,.12941)!important;">
                                    <p class="checkbox-label heading-title" style="font-size:15px"> {{data.name}} at ₹{{data.price}}</p>

                  <label :for="index" class="labels m-0 p-0">{{data.description}}</label>
                  <input type="checkbox" :id="index" class=" addonsCheckbox" v-if="data.status == 'active'" :value="data" v-model="selectedaddons"> 
          ...
          <transition name="fade">
            <div class="col-md-12 m-0 p-0" v-if="currentSelected && variant && colorCheck">
                  ...
                  <div class="p-4  mt-1 card " style="box-shadow: 0 1px 12px rgba(51,51,51,.12941)!important; border:none;">
                    ...
                    <div class=" p-3" :class="{'ifselected':books == 'Thanks for choosing Ontrack'}" style="box-shadow: 0 1px 12px rgba(51,51,51,.12941)!important;border-radius:5px;">
                      <label for="book1000" style="font-family:gilroyf"><input id="book1000" type="radio" value="Thanks for choosing Ontrack" v-model="books"> Pay Full</label><br>
                      <label for="book1000" class="mb-0" style="font-size:13px">Get home delivered by paying showroom price</label>
                    </div>
                    <div class= " p-3 my-3 " :class="{'ifselected':books == 'Book bike at Rs. 1000'}" style="box-shadow: 0 1px 12px rgba(51,51,51,.12941)!important;border-radius:5px;">
                      <label for="book" style="font-family:gilroyf"><input id="book" type="radio" value="Book bike at Rs. 1000" v-model="books"> Pay 1000</label>
                      <br>
                      <label for="book" class="mb-0" style="font-size:13px">Book Now by paying Rs. 1000.</label>
                    </div>
                    <!-- <label for="book20000"><input id="book20000" type="radio" value="book bike at rupees Rs. 20000" v-model="books"> Book 20000</label>
                    <label for="book30000"><input id="book30000" type="radio" value="book bike at rupees Rs. 30000" v-model="books"> Book 30000</label> -->
      ...
      <div class="col-md-12 m-0 p-0 mt-2">
        ...
        <div class="fixed-bottom display-mobile mobile-panel col-12 m-0 p-0 py-2">
            <div class="col-12 row m-0 p-0">
              ...
              <button class="start-purchase py-3 m-0"  @click="startpurchase">Start Purchase</button>
              </div>
              <div class="col-6 p-0 m-0 text-center" >
                <button class="reserve py-3 m-0" @click="reserve" >RESERVE(₹1,000)</button>
              </div>
            </div>
        </div>
