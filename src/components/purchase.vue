...
export default {
  ...
  methods: {
    fetch() {
      ...
      this.$http
        .post(
          "https://ontrack-backend-express-v1.herokuapp.com/api/otr_purchase/fetch-order-by-phone",
          {
            phone: this.phone,
          }
        )
    ...
    sendOtp() {
      if (this.phone.length > 9) {
        ...
        this.$http
          .post("https://ontrack-backend-express-v1.herokuapp.com/api/customers/sendotp", {
            phone: this.phone,
          })
          .then((response) => {
    ...
    resendotp() {
      this.$http
        .post("https://ontrack-backend-express-v1.herokuapp.com/api/customers/otp-retry", {
          phone: this.phone,
        })
        .then((response) => {
          if (response.body.type == "success") {
    ...
    verifyOtpandFetch() {
      this.loading = true;
      this.$http
        .post("https://ontrack-backend-express-v1.herokuapp.com/api/customers/verifyotp", {
          phone: this.phone,
          otp: this.otp,
        })
        .then((response) => {
